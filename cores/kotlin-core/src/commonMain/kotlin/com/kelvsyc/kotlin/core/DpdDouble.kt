...
import com.kelvsyc.kotlin.core.traits.dfp.Dpd64
...
value class DpdDouble(val bits: Long) {
    companion object : Dpd64<DpdDouble> {
        ...
        override val classification: IeeeFloatingPointClassification<DpdDouble> =
            object : IeeeFloatingPointClassification<DpdDouble> {
                ...
                override fun DpdDouble.isInteger(): Boolean = this.isInteger()
            }

        override fun DpdDouble.isPowerOfTen(): Boolean {
    ...
    fun isInteger(): Boolean {
        ...
        val fracExp = 398 - biasedExponent
        if (fracExp > 15) return false
