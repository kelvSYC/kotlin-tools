...
import com.kelvsyc.internal.kotlin.core.collections.ImmutableEnumSetMultimap
...
inline fun <reified K : Enum<K>, V> emptyEnumSetMultimap(): EnumSetMultimap<K, V> =
    ImmutableEnumSetMultimap(ArrayEnumSetMultimap(enumEntries<K>()))
...
inline fun <reified K : Enum<K>, V> enumSetMultimapOf(vararg pairs: Pair<K, V>): EnumSetMultimap<K, V> =
    ImmutableEnumSetMultimap(ArrayEnumSetMultimap<K, V>(enumEntries<K>()).apply { putAll(pairs.asIterable()) })
...
): EnumSetMultimap<K, V> = ImmutableEnumSetMultimap(ArrayEnumSetMultimap<K, V>(enumEntries<K>()).apply(builderAction))
...
inline fun <reified K : Enum<K>, V> Iterable<Pair<K, V>>.toEnumSetMultimap(): EnumSetMultimap<K, V> =
    ImmutableEnumSetMultimap(ArrayEnumSetMultimap<K, V>(enumEntries<K>()).apply { putAll(this@toEnumSetMultimap) })
