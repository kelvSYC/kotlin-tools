...
/**
 * Returns the exact mathematical value of this `DpdDouble` as a [BigDecimal].
 *
 * Unlike binary floating-point types, `DpdDouble` cannot be exactly widened to a [Double] — decimal
 ...
 */
fun DpdDouble.toBigDecimal(): BigDecimal {
